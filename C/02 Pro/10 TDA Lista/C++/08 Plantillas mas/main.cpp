...
void usaListaPersonas(){
    Lista<Persona> alpha(MAX_ELEMENTOS_LISTA_ALPHA),
        beta(MAX_ELEMENTOS_LISTA_BETA),gamma(MAX_ELEMENTOS_LISTA_GAMMA);
...
void usaListaComputadoras(){
    Lista<Computadora> alpha(MAX_ELEMENTOS_LISTA_ALPHA),
        beta(MAX_ELEMENTOS_LISTA_BETA),
        gamma(MAX_ELEMENTOS_LISTA_GAMMA);
...
/*void usaListaEnteros(){
    Lista<int> alpha(MAX_ELEMENTOS_LISTA_ALPHA),
        beta(MAX_ELEMENTOS_LISTA_BETA),gamma(MAX_ELEMENTOS_LISTA_GAMMA);
