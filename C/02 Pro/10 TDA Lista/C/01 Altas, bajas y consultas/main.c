...
int main()
{
    ...
    printf("Localizado elemento en posicion p=%d...\n",p);
    pausar();
    printf("Imprimiendo lo que recibi de posicion\n");
    imprimeElemento(recupera(p,&lis));
    printf("\n");
    pausar();
    recuperado=*recupera(p,&lis);
    printf("El elemento recuperado es: ");
    imprimeElemento(&recuperado);
    printf("\n");
    pausar();
    printf("Suprimiendo elemento en posicion p=%d\n",p);
    suprime(p,&lis);
    imprimeLista(&lis);
